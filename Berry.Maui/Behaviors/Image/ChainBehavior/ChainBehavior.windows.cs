...
public partial class ChainBehavior : PlatformBehavior<Image, Microsoft.UI.Xaml.Controls.Image>
{
    ...
    protected override async void OnAttachedTo(
        Image bindable,
        Microsoft.UI.Xaml.Controls.Image platformView
    )
    {
    ...
    static IGraphicsEffect? CreateEffectByName(
        string effectName,
        IGraphicsEffectSource? source = null
    )
    {
