...
namespace Berry.Maui.Controls.Effects.iOS.GestureRecognizers;
...
public class TouchGestureRecognizer : UIGestureRecognizer
{
    ...
    public override void TouchesEnded(NSSet touches, UIEvent evt)
    {
        ...
        OnTouch?.Invoke(
            this,
            new TouchArgs(TouchState.Ended, View.PointInside(LocationInView(View), null))
        );
        State = UIGestureRecognizerState.Ended;
        IsActive = false;
    }
...
public class TouchGestureRecognizerDelegate : UIGestureRecognizerDelegate
{
    ...
    {
        if (
            gestureRecognizer is TouchGestureRecognizer rec
