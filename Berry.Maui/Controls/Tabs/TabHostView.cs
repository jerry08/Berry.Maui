...
#endif
{
    ...
    protected override void OnPropertyChanged([CallerMemberName] string propertyName = null)
    {
        ...
        switch (propertyName)
        {
            ...
            case nameof(Tabs):
                throw new NotSupportedException(
                    "Updating Tabs collection reference is not supported"
                );
        }
    }

    private static void OnSegmentedHasSeparatorChanged(
    ...
    private static void SelectedIndexPropertyChanged(
        BindableObject bindable,
        object oldvalue,
        object newvalue
    )
    {
        ...
        tabHostView.RaiseSelectedTabIndexChanged(
            new SelectedPositionChangedEventArgs(selectedIndex)
        );
    }
    ...
    private void ItemsSourceCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
    {
        ...
        switch (e.Action)
        {
            ...
            case NotifyCollectionChangedAction.Remove:
                for (
                    var removedIndex = e.OldStartingIndex + (e.OldItems.Count - 1);
            ...
            default:
                Console.WriteLine(
                    "Warning: TabHostView ItemsSource only support Add, Remove and Reset actions"
                );
                break;
        }
    }
    ...
    {
        for (var i = 0; i < _grid.Children.Count - 1; i++)
        {
    ...
    private void UpdateTabType()
    {
        ...
        if (TabType == TabType.Scrollable)
        {
            base.Content = _scrollView ??= new ScrollView
            {
                ...
                HorizontalScrollBarVisibility = ShowScrollbar
    ...
    private void AddTapCommand(TabItem tabItem)
    {
        ...
        {
#if NET6_0_OR_GREATER
            Berry.Maui.Controls.Effects.TouchEffect.SetColor(tabItem, tabItem.SelectedTabColor);
            Berry.Maui.Controls.Effects.Commands.SetTap(tabItem, TabItemTappedCommand);
            Berry.Maui.Controls.Effects.Commands.SetTapParameter(tabItem, tabItem);
#else
