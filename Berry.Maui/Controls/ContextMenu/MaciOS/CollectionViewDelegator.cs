...
public class CollectionViewDelegator
    : ReorderableItemsViewDelegator<ReorderableItemsView, CollectionViewController>
{
    NSIndexPath? _highlightedIndexPath;

    public CollectionViewDelegator(
        ItemsViewLayout itemsViewLayout,
        CollectionViewController itemsViewController
    )
    ...
    UITargetedPreview MakeTargetedPreview(
        UICollectionView collectionView,
        UIContextMenuConfiguration configuration
    )
    {
