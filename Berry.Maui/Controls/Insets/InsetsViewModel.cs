...
public partial class Insets : BindableObject
{
    ...
    public static readonly BindableProperty EdgeToEdgeProperty = BindableProperty.CreateAttached(
        "EdgeToEdge",
        typeof(bool),
        typeof(Insets),
        false,
        propertyChanged: EdgeToEdgeChanged
    );
    ...
    public static readonly BindableProperty CancelIOSPaddingProperty =
        BindableProperty.CreateAttached(
            ...
            typeof(Insets),
            false,
            propertyChanged: CancelIOSPaddingChanged
        );

    private static void CancelIOSPaddingChanged(
    ...
    private static void PagePropertyChanged(
        object? sender,
    ...
    public Thickness TopInsetThickness =>
        _enabled ? new Thickness(0, _insets.Top, 0, 0) : new Thickness(0);
    public Thickness BottomInsetThickness =>
        _enabled ? new Thickness(0, 0, 0, _insets.Bottom) : new Thickness(0);
