...
internal partial class BottomSheetManager
{
    ...
    static partial void PlatformShow(Window window, BottomSheet sheet, bool animated)
    {
        ...
        if (OperatingSystem.IsIOSVersionAtLeast(15))
        {
            ...
            {
                controller.SheetPresentationController.LargestUndimmedDetentIdentifier =
            ...
            controller.SheetPresentationController.SelectedDetentIdentifier =
                BottomSheetViewController.GetIdentifierForDetent(sheet.SelectedDetent);
        }
