...
public static partial class ColorAnimationExtensions
{
    ...
    public static Task<bool> BackgroundColorTo(
    ...
    )
    {
        ...
        try
        {
            new Animation
            {
                ...
                length,
                easing,
                (d, b) => animationCompletionSource.SetResult(true)
            );
        }
        catch (ArgumentException aex)
        {
            ...
            System.Diagnostics.Trace.WriteLine(
                $"{aex.GetType().Name} thrown in {typeof(ColorAnimationExtensions).FullName}: {aex.Message}"
            );
        ...
        static Animation GetRedTransformAnimation(VisualElement element, float targetRed) =>
            new(
                v => element.BackgroundColor = element.BackgroundColor.WithRed(v),
        ...
        static Animation GetGreenTransformAnimation(VisualElement element, float targetGreen) =>
            new(
                v => element.BackgroundColor = element.BackgroundColor.WithGreen(v),
        ...
        static Animation GetBlueTransformAnimation(VisualElement element, float targetBlue) =>
            new(
                v => element.BackgroundColor = element.BackgroundColor.WithBlue(v),
        ...
        static Animation GetAlphaTransformAnimation(VisualElement element, float targetAlpha) =>
            new(
                v => element.BackgroundColor = element.BackgroundColor.WithAlpha((float)v),
                element.BackgroundColor.Alpha,
                targetAlpha
            );
    }
}
