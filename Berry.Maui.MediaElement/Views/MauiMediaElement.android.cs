...
#pragma warning disable IDE0060 // Remove unused parameter
    public MauiMediaElement(nint ptr, JniHandleOwnership jni)
        : base(Platform.AppContext)
    {
...
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    public override void OnDetachedFromWindow()
    {
        if (isFullScreen)
        {
            OnFullscreenButtonClick(
                this,
                new StyledPlayerView.FullscreenButtonClickEventArgs(!isFullScreen)
            );
        }
    ...
    protected override void OnVisibilityChanged(
        Android.Views.View changedView,
    ...
    static (
        ...
        Android.Views.Window CurrentWindow,
        Resources CurrentWindowResources,
        Configuration CurrentWindowConfiguration
    ) VerifyAndRetrieveCurrentWindowResources()
    {
        // Ensure current activity and window are available
        if (Platform.CurrentActivity is not Activity currentActivity)
        {
            throw new InvalidOperationException(
                "CurrentActivity cannot be null when the FullScreen button is tapped"
            );
        }
        if (currentActivity.Window is not Android.Views.Window currentWindow)
        {
            throw new InvalidOperationException(
                "CurrentActivity Window cannot be null when the FullScreen button is tapped"
            );
        }
        ...
        {
            throw new InvalidOperationException(
                "CurrentActivity Resources cannot be null when the FullScreen button is tapped"
            );
        }
        ...
        {
            throw new InvalidOperationException(
                "CurrentActivity Configuration cannot be null when the FullScreen button is tapped"
            );
        }
    ...
    void OnFullscreenButtonClick(object? sender, StyledPlayerView.FullscreenButtonClickEventArgs e)
    {
        ...
        {
            throw new InvalidOperationException(
                "PlayerView cannot be null when the FullScreen button is tapped"
            );
        }
        ...
        if (e.IsFullScreen)
        {
            ...
            var item = new RelativeLayout.LayoutParams(
    ...
    void SetSystemBarsVisibility()
    {
        ...
        var windowInsetsControllerCompat = WindowCompat.GetInsetsController(
            currentWindow,
        ...
        if (isFullScreen)
        {
            ...
            else
            {
                ...
                currentWindow.DecorView.SystemUiFlags =
                    currentWindow.DecorView.SystemUiFlags
        ...
        else
        {
            ...
            windowInsetsControllerCompat.SystemBarsBehavior =
                WindowInsetsControllerCompat.BehaviorDefault;
        }
    }
}
