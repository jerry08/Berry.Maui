...
static partial class SafeFireAndForgetExtensions
{
    ...
    static async void HandleSafeFireAndForget<TException>(
        ValueTask valueTask,
    ...
    static async void HandleSafeFireAndForget<T, TException>(
    ...
    static void HandleException<TException>(
        in TException exception,
        in Action<TException>? onException
    )
        where TException : Exception
    {
